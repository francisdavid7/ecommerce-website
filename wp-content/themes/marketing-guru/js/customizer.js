 ...
 */
 ...
 ( function( $ ) {
	...
	// Color preview
	wp.customize( 'marketing_guru_sidebar_headline_border', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'marketing_guru_sidebar_bgcolor', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'blogfeed_readmore_link', function( value ) {
		value.bind( function( to ) {
			$( '.blogposts-list .entry-content a' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'dropdown_background_color', function( value ) {
		value.bind( function( to ) {
			$( '#smobile-menu, .primary-menu ul li ul.children, .primary-menu ul li ul.sub-menu ' ).css( {
				'background':to
			});
		} );
	} );
	wp.customize( 'dropdown_text_color', function( value ) {
		value.bind( function( to ) {
			$( '#smobile-menu.show .toggle-mobile-menu:before, #smobile-menu *, .main-navigation ul.sub-menu li .sub-arrow, .main-navigation ul.sub-menu li a, .primary-menu ul li ul.children, .primary-menu ul li ul.sub-menu' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'header_img_buttoncolor', function( value ) {
		value.bind( function( to ) {
			$( '.header-button-solid' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'footer_headline_color', function( value ) {
		value.bind( function( to ) {
			$( 'footer#colophon h3, footer#colophon h3 *, footer#colophon h4, footer#colophon h4 *, footer#colophon h5, footer#colophon h5 *, footer#colophon h6, footer#colophon h6 *, footer#colophon h1, footer#colophon h1 *, footer#colophon h2, footer#colophon h2 *, footer#colophon h4, footer#colophon h4 *, footer#colophon h3 a' ).css( {
				'color':to
			});
		} );
	} );
	wp.customize( 'footer_link_color', function( value ) {
		value.bind( function( to ) {
			$( '.footer-column-three a, .footer-column-three li a, .footer-column-three .widget a, .footer-column-three .sub-arrow, .site-footer a, .site-info a, .site-footer * a, .site-footer a' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'blogfeed_buttonbg_color', function( value ) {
		value.bind( function( to ) {
			$( '.page-numbers li a, .blogposts-list .blogpost-button, span.page-numbers.dots, .page-numbers.current' ).css( {
				'background':to
			});
		} );
	} );
	...
	wp.customize( 'postpage_byline_color', function( value ) {
		value.bind( function( to ) {
			$( '.single .entry-meta, .page .entry-meta' ).css( {
				'color':to
			});
		} );
	} );
	wp.customize( 'postpage_buttonbg_color', function( value ) {
		value.bind( function( to ) {
			$( '.comments-area p.form-submit input, .error404 input.search-submit, .search-no-results input.search-submit' ).css( {
				'background':to
			});
		} );
	} );
	...
	wp.customize( 'postpage_buttontext_color', function( value ) {
		value.bind( function( to ) {
			$( '.single .comments-area p.form-submit input, .page .comments-area p.form-submit input, .comments-area p.form-submit input, .error404 input.search-submit, .search-no-results input.search-submit' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'upperwidgets_title_color', function( value ) {
		...
		value.bind( function( to ) {
			$( '.header-widgets-wrapper .swidgets-wrap, .header-widgets-three' ).css( {
				'background':to
			});
		} );
	} );
	...
	wp.customize( 'blogfeed_bg_color', function( value ) {
		...
		value.bind( function( to ) {
			$( '.comments-area, .single #primary.featured-content, .page #primary.featured-content, .error404 #primary.featured-content, .search-no-results #primary.featured-content' ).css( {
				'background':to
			});
		} );
	} );
